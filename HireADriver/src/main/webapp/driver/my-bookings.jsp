...
<head>
    ...
    <title>My Assigned Bookings - Hire A Driver</title>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <% if ("CONFIRMED".equals(
                            ...
                            <a class="start-btn"
                               href="<%= request.getContextPath() %>/driver/start-trip?bookingId=<%= bookings.getInt("booking_id") %>"
                        ...
                        <% } else if ("STARTED".equals(
                            ...
                            <a class="complete-btn"
                               href="<%= request.getContextPath() %>/driver/complete-trip?bookingId=<%= bookings.getInt("booking_id") %>"
                               onclick="return confirm('Complete this trip?');">
                                Complete Trip
                            </a>
